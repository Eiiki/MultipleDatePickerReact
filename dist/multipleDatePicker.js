...
var MultipleDatePicker = React.createClass({displayName: "MultipleDatePicker",
	componentWillMount: function() {
	...
	getDaysOfWeek: function () {
        ...
        return days.map(function(day, i){
			return (React.createElement("div", {key: day, className: "text-center"}, day));
		});
    },
    getEmptyFirstDays: function(firstDayOfMonth){
	    ...
	    return Array.apply(0, new Array(emptyFirstDaysStartIndex)).map(function(o, i){
			return (React.createElement("div", {key: 'emptyFirst' + i, className: "text-center picker-day picker-empty"}, " "));
		});
    },
    getEmptyLastDays: function(lastDayOfMonth){
	    ...
	    return Array.apply(0, new Array(emptyLastDaysStartIndex)).map(function(o, i){
			return (React.createElement("div", {key: 'emptyLast' + i, className: "text-center picker-day picker-empty"}, " "));
		});
    },
	...
	render: function(){
		...
		return (
			React.createElement("div", {className: "multiple-date-picker"}, 
	            React.createElement("div", {className: "picker-top-row"}, 
		            React.createElement("div", {className: "text-center picker-navigate picker-navigate-left-arrow", onClick: this.goToPreviousMonth}, "<"), 
		            React.createElement("div", {className: "text-center picker-month"}, this.state.month.format('MMMM YYYY')), 
		            React.createElement("div", {className: "text-center picker-navigate picker-navigate-right-arrow", onClick: this.goToNextMonth}, ">")
	            ), 
	            React.createElement("div", {className: "picker-days-week-row"}, this.getDaysOfWeek()), 
	            React.createElement("div", {className: "picker-days-row"}, 
